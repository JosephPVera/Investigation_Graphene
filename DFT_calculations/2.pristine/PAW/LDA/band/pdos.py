...
energy, pdos_s = data_loader('graphene_pdos.dat.pdos_atm#1(C)_wfc#1(s)')
_, pdos_p = data_loader('graphene_pdos.dat.pdos_atm#1(C)_wfc#2(p)')
...
plt.tight_layout()
plt.savefig("graphene_pdos-atom_1.png", dpi=300)
