...
# === Cargar archivos ===
energy, pdos_s = load_pdos("graphene_pdos.dat.pdos_atm#2(C)_wfc#1(s_j0.5)", EFermi)
_, pdos_pj05 = load_pdos("graphene_pdos.dat.pdos_atm#2(C)_wfc#2(p_j0.5)", EFermi)
_, pdos_pj15 = load_pdos("graphene_pdos.dat.pdos_atm#2(C)_wfc#3(p_j1.5)", EFermi)
...
plt.legend()
plt.tight_layout()
plt.savefig("graphene_pdos_SOC-atomo_2.png", dpi=300)
#plt.show()
