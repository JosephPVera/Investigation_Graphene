...
plt.axvline(0.666667, linewidth=0.2, color='xkcd:black')
plt.axvline(1.0000, linewidth=0.2, color='xkcd:black')

# text labels
plt.xticks(ticks= [0, 0.666667, 1.000, 1.577350], labels=[r'$\Gamma$', 'K', 'M', r'$\Gamma$'], fontsize=12)

#plt.ylabel('Energy (eV)', fontsize=14)
plt.ylabel(r'Energy ($\mu$eV)', fontsize=14)
#plt.ylim(-10, 5)

#plt.xlim(0.6666669, 0.6666671)
plt.xlim(0.6666667, 0.6666673)
