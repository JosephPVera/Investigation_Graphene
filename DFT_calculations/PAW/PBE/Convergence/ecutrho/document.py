...
# Labels and title
plt.xlabel("Energía de corte para la densidad de carga (Ry)", fontsize=12)
plt.ylabel("Total Energy (Ry)", fontsize=12)
plt.title("ecutrho vs Total Energy", fontsize=14)
...
# Show the plot
plt.tight_layout()
plt.savefig("convergence_ecutrho.png", dpi=150)
#plt.show()
